                ...
                <div class="flex-1 p-4">
                    <div class="flex items-center">
                        <div class="relative md:w-1/2">
                            <input type="search" wire:model="buscar" class="w-full pl-10 pr-4 py-2 rounded-lg shadow focus:outline-none focus:shadow-outline text-gray-600 font-medium border-gray-300" placeholder="Search...">
